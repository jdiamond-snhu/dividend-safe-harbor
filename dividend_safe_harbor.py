...
ticker_input = st.text_input(
    label="Enter ticker symbols of **dividend-paying stocks** in the field below (separated by commas):",
    value="SPY, JNJ, KO,",
)
...
if analysis_data:
    ...
    st.info("💡 Pro Tip: Inflation rate is set to the national average. Changing it may change the recommended projected Allocation Grade for some equities.")
else:
